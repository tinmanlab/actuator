...
(async()=>{
 ...
 try{
  ...
  ok(await page.locator('#gate-scope').getAttribute('data-cursor-us')===await page.locator('#voltage-scope').getAttribute('data-cursor-us'),'gate and phase-voltage scopes share one selected PWM time');
